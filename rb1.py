...
# driver = webdriver.Chrome(executable_path=r'C:\Users\taran\PycharmProjects\pyton2Learning\chromedriver.exe')
# firefoxd = Service(executable_path=r'C:\Users\taran\Downloads\geckodriver-v0.35.0-win64\geckodriver.exe')
# driver = webdriver.Firefox(service=firefoxd)
